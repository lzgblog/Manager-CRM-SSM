			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/student/editStudent" id="editfrom" method="post">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <label class="checkbox-inline">
									   	<input type="radio" name="sex" value="男" ${student.sex=="男"? "checked":"unchecked"}>男
									</label>
									<label class="checkbox-inline">
										<input type="radio" name="sex" value="女" ${student.sex=="女"? "checked":"unchecked"}>女
									</label>
							    </div>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <select class="form-control" name="collegeid" id="college">
											...
											<option value="${student.collegeid}">${student.collegeName}</option>
