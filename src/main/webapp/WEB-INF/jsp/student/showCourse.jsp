...
<body>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <table class="table table-bordered">
					        ...
					        <tbody>
							<c:forEach  items="${ext.listCourse}" var="item">
								<tr>
									<td>${item.courseid}</td>
				    ...
				    <div class="panel-footer">
							...
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="/student/showCourse?page=${ext.currentPage==1? 1:ext.currentPage-1}">&laquo;上一页</a></li>
									<li><a href="/student/showCourse?page=${ext.currentPage}">${ext.currentPage}</a></li>
									<li><a href="/student/showCourse?page=${ext.currentPage==ext.pageCount? ext.pageCount:ext.currentPage+1}">下一页&raquo;</a></li>
	...
	<script type="text/javascript">
    	...
    	if(date!=""){
    		alert(date);
    		location.href="/student/showCourse";
    	}
