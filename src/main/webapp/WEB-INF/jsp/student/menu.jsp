...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="/student/goStudentInfo">个人信息<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
        <li><a href="/student/goPasswordRestPage">修改密码<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
